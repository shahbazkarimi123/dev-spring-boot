package com.karimi.cruddemo.entity;
...
public class InstructorDetail {
    ...
    // annotate the class as an entity table and map to db table
    ...
    // remove cascadeType.ALL because we don't wanna remove instructionDetail this time so
